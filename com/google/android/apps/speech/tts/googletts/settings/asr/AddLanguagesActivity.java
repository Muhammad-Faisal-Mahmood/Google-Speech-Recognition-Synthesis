...
public final class AddLanguagesActivity
extends bxu
implements ggz,
ghv {
    private bxg l;
    ...
    public AddLanguagesActivity() {
        this.z(new mn(this, 2));
    }
    ...
    protected final void onCreate(Bundle object) {
        ...
        try {
            ...
            object = this.v();
            if (!ite.c()) {
                ((heg)((heg)bxg.a.h()).j("com/google/android/apps/speech/tts/googletts/settings/asr/AddLanguagesActivityPeer", "onCreate", 30, "AddLanguagesActivityPeer.java")).r("No settings page for Google Speech ASR");
                ((bxg)object).b.finish();
            } else {
                object2 = ((bxg)object).b.bb();
    ...
    public final boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        try {
            ...
            if (menuItem.getItemId() == 16908332) {
                ...
                bxg2.b.onOptionsItemSelected(menuItem);
            }
            return true;
        }
        finally {
    ...
    public final void t() {
        ...
        block14: {
            ...
            try {
                object = this.bn();
                object = ((brb)object).a();
                if (object instanceof AddLanguagesActivity) {
                    bxg bxg2;
                    object = (AddLanguagesActivity)object;
                    this.l = bxg2 = new bxg((AddLanguagesActivity)object);
                    gol2.close();
                    return;
                }
                IllegalStateException illegalStateException = new IllegalStateException(a.au((bh)object, bxg.class));
