...
public class DrawableStateLinearLayout
...
implements boj {
    ...
    public DrawableStateLinearLayout(Context context, AttributeSet attributeSet, int n2) {
    ...
    public final int[] onCreateDrawableState(int n2) {
        ...
        return this.a.b(n2, new bof(this, 4));
    }
}
