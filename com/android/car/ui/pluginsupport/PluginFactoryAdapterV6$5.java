...
import com.android.car.ui.pluginsupport.PluginFactoryAdapterV6$5$$ExternalSyntheticLambda0;
import java.util.List;
import java.util.function.Function;

class PluginFactoryAdapterV6$5
extends kh {
    final List val$items;
    final List val$oemItems;

    public PluginFactoryAdapterV6$5(PluginFactoryAdapterV6 pluginFactoryAdapterV6, List list, List list2) {
        this.val$oemItems = list;
        this.val$items = list2;
    }

    static /* synthetic */ ListItemOEMV1 lambda$onChanged$0(blf blf2) {
        return PluginFactoryAdapterV6.-$$Nest$smtoOemListItem(blf2);
    }

    @Override
    public void onChanged() {
        this.val$oemItems.clear();
        Object object = new PluginFactoryAdapterV6$5$$ExternalSyntheticLambda0();
    ...
    public void onItemRangeChanged(int n2, int n3) {
        for (int i2 = n2; i2 <= n2 + n3; ++i2) {
            this.val$oemItems.set(i2, PluginFactoryAdapterV6.-$$Nest$smtoOemListItem((blf)this.val$items.get(i2)));
        }
    }
    ...
    public void onItemRangeInserted(int n2, int n3) {
        for (int i2 = n2; i2 <= n2 + n3; ++i2) {
            this.val$oemItems.add(i2, PluginFactoryAdapterV6.-$$Nest$smtoOemListItem((blf)this.val$items.get(i2)));
        }
    }
