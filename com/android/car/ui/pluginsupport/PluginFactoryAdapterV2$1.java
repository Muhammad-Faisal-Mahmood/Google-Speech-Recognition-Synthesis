...
import com.android.car.ui.pluginsupport.PluginFactoryAdapterV2$1$$ExternalSyntheticLambda0;
import java.util.List;
import java.util.function.Function;

class PluginFactoryAdapterV2$1
extends kh {
    final List val$items;
    final List val$oemItems;

    public PluginFactoryAdapterV2$1(PluginFactoryAdapterV2 pluginFactoryAdapterV2, List list, List list2) {
        this.val$oemItems = list;
        this.val$items = list2;
    }

    static /* synthetic */ ListItemOEMV1 lambda$onChanged$0(blf blf2) {
        return PluginFactoryAdapterV2.-$$Nest$smtoOemListItem(blf2);
    }

    @Override
    public void onChanged() {
        this.val$oemItems.clear();
        Object object = new PluginFactoryAdapterV2$1$$ExternalSyntheticLambda0();
    ...
    public void onItemRangeChanged(int n2, int n3) {
        for (int i2 = n2; i2 <= n2 + n3; ++i2) {
            this.val$oemItems.set(i2, PluginFactoryAdapterV2.-$$Nest$smtoOemListItem((blf)this.val$items.get(i2)));
        }
    }
    ...
    public void onItemRangeInserted(int n2, int n3) {
        for (int i2 = n2; i2 <= n2 + n3; ++i2) {
            this.val$oemItems.add(i2, PluginFactoryAdapterV2.-$$Nest$smtoOemListItem((blf)this.val$items.get(i2)));
        }
    }
