...
class PluginFactoryAdapterV4$6
implements RecyclerViewAttributesOEMV1 {
    ...
    public PluginFactoryAdapterV4$6(boolean bl2, int n2, LayoutStyleOEMV1 layoutStyleOEMV1, int n3, int n4, int n5, int n6, int n7, boolean bl3, int n8, int n9, int n10, int n11, int n12, int n13, int n14, int n15, int n16, int n17, int n18, Drawable drawable) {
