...
class RecyclerViewAdapterAdapterV2$1
extends kh {
    final RecyclerViewAdapterAdapterV2 this$0;

    public RecyclerViewAdapterAdapterV2$1(RecyclerViewAdapterAdapterV2 recyclerViewAdapterAdapterV2) {
        this.this$0 = recyclerViewAdapterAdapterV2;
    }

    @Override
    public void onChanged() {
        Iterator iterator = RecyclerViewAdapterAdapterV2.-$$Nest$fgetmAdapterDataObservers(this.this$0).iterator();
    ...
    public void onItemRangeMoved(int n2, int n3, int n4) {
        for (AdapterDataObserverOEMV1 adapterDataObserverOEMV1 : RecyclerViewAdapterAdapterV2.-$$Nest$fgetmAdapterDataObservers(this.this$0)) {
