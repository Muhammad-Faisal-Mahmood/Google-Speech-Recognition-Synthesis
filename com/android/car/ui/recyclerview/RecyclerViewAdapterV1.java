 ...
 *  com.android.car.ui.plugin.oemapis.recyclerview.OnScrollListenerOEMV1
...
import com.android.car.ui.recyclerview.RecyclerViewAdapterV1$1;
import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

public final class RecyclerViewAdapterV1
extends FrameLayout
...
boe {
    ...
    public RecyclerViewAdapterV1(Context context, AttributeSet attributeSet, int n2) {
    ...
    public ViewPropertyAnimator animate() {
        ...
        if (recyclerViewOEMV1 != null) {
            return recyclerViewOEMV1.getView().animate();
        }
    ...
    public lg findViewHolderForAdapterPosition(int n2) {
        ...
        if (viewHolderOEMV1 instanceof RecyclerViewAdapterAdapterV1$ViewHolderAdapterV1) {
            return ((RecyclerViewAdapterAdapterV1$ViewHolderAdapterV1)viewHolderOEMV1).getViewHolder();
        }
        return null;
    }
    ...
    public int getPaddingBottom() {
        RecyclerViewOEMV1 recyclerViewOEMV1 = this.mOEMRecyclerView;
        if (recyclerViewOEMV1 != null) {
            return recyclerViewOEMV1.getView().getPaddingBottom();
        }
    ...
    public int getPaddingLeft() {
        RecyclerViewOEMV1 recyclerViewOEMV1 = this.mOEMRecyclerView;
        if (recyclerViewOEMV1 != null) {
            return recyclerViewOEMV1.getView().getPaddingLeft();
        }
    ...
    public int getPaddingRight() {
        RecyclerViewOEMV1 recyclerViewOEMV1 = this.mOEMRecyclerView;
        if (recyclerViewOEMV1 != null) {
            return recyclerViewOEMV1.getView().getPaddingRight();
        }
    ...
    public int getPaddingTop() {
        RecyclerViewOEMV1 recyclerViewOEMV1 = this.mOEMRecyclerView;
        if (recyclerViewOEMV1 != null) {
            return recyclerViewOEMV1.getView().getPaddingTop();
        }
    ...
    public int getScrollState() {
        return RecyclerViewAdapterV1.toInternalScrollState(this.mOEMRecyclerView.getScrollState());
    }
    ...
    public void onScrollStateChanged(RecyclerViewOEMV1 object, int n2) {
    ...
    public void onScrolled(RecyclerViewOEMV1 object, int n2, int n3) {
        object = this.mScrollListeners.iterator();
        while (object.hasNext()) {
            ((blk)object.next()).b();
        }
    ...
    public void setAdapter(kf kf2) {
        ...
        this.mAdapter = kf2;
        object = new RecyclerViewAdapterAdapterV1(this.getContext(), kf2);
        this.mOEMAdapter = object;
        this.mOEMRecyclerView.setAdapter((AdapterOEMV1)object);
    ...
    public void setBackgroundColor(int n2) {
        RecyclerViewOEMV1 recyclerViewOEMV1 = this.mOEMRecyclerView;
        if (recyclerViewOEMV1 != null) {
            recyclerViewOEMV1.getView().setBackgroundColor(n2);
        }
    }
    ...
    public void setClipToPadding(boolean bl2) {
        RecyclerViewOEMV1 recyclerViewOEMV1 = this.mOEMRecyclerView;
        if (recyclerViewOEMV1 != null) {
            recyclerViewOEMV1.setClipToPadding(bl2);
        }
    }
    ...
    @Override
    public void setLayoutStyle(bld bld2) {
        this.mLayoutStyle = bld2;
        if (bld2 == null) {
            this.mOEMRecyclerView.setLayoutStyle(null);
            return;
        }
        RecyclerViewAdapterV1$1 recyclerViewAdapterV1$1 = new RecyclerViewAdapterV1$1(this, bld2);
        bld2 = this.mOEMRecyclerView;
        if (bld2 != null) {
            bld2.setLayoutStyle(recyclerViewAdapterV1$1);
        }
    }

    public void setOemRecyclerView(RecyclerViewOEMV1 object, RecyclerViewAttributesOEMV1 object2) {
        ...
        object = new FrameLayout(this.getContext());
        object2 = new bmb(this.getContext(), this);
        this.mRecyclerView = object2;
        object.addView((View)object2);
        this.mOEMRecyclerView.addOnScrollListener((OnScrollListenerOEMV1)this);
    ...
    public void setPadding(int n2, int n3, int n4, int n5) {
        RecyclerViewOEMV1 recyclerViewOEMV1 = this.mOEMRecyclerView;
        if (recyclerViewOEMV1 != null) {
            recyclerViewOEMV1.getView().setPadding(n2, n3, n4, n5);
        }
    }
    ...
    public void setPaddingRelative(int n2, int n3, int n4, int n5) {
        RecyclerViewOEMV1 recyclerViewOEMV1 = this.mOEMRecyclerView;
        if (recyclerViewOEMV1 != null) {
            recyclerViewOEMV1.getView().setPaddingRelative(n2, n3, n4, n5);
        }
    }
