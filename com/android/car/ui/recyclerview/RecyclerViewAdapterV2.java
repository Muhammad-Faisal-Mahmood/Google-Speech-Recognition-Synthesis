 ...
 *  com.android.car.ui.plugin.oemapis.recyclerview.RecyclerViewOEMV2$OnScrollListenerOEMV2
...
import com.android.car.ui.recyclerview.RecyclerViewAdapterV2$1;
...
boe {
    ...
    public RecyclerViewAdapterV2(Context context, AttributeSet attributeSet, int n2) {
    ...
    public int getPaddingBottom() {
        RecyclerViewOEMV2 recyclerViewOEMV2 = this.mOEMRecyclerView;
        if (recyclerViewOEMV2 != null) {
            return recyclerViewOEMV2.getView().getPaddingBottom();
        }
    ...
    public int getPaddingLeft() {
        RecyclerViewOEMV2 recyclerViewOEMV2 = this.mOEMRecyclerView;
        if (recyclerViewOEMV2 != null) {
            return recyclerViewOEMV2.getView().getPaddingLeft();
        }
    ...
    public int getPaddingRight() {
        RecyclerViewOEMV2 recyclerViewOEMV2 = this.mOEMRecyclerView;
        if (recyclerViewOEMV2 != null) {
            return recyclerViewOEMV2.getView().getPaddingRight();
        }
    ...
    public int getPaddingTop() {
        RecyclerViewOEMV2 recyclerViewOEMV2 = this.mOEMRecyclerView;
        if (recyclerViewOEMV2 != null) {
            return recyclerViewOEMV2.getView().getPaddingTop();
        }
    ...
    public void onScrollStateChanged(RecyclerViewOEMV2 object, int n2) {
    ...
    public void onScrolled(RecyclerViewOEMV2 object, int n2, int n3) {
        object = this.mScrollListeners.iterator();
        while (object.hasNext()) {
            ((blk)object.next()).b();
        }
    ...
    public void setBackgroundColor(int n2) {
        RecyclerViewOEMV2 recyclerViewOEMV2 = this.mOEMRecyclerView;
        if (recyclerViewOEMV2 != null) {
            recyclerViewOEMV2.getView().setBackgroundColor(n2);
        }
    }
    ...
    public void setClipToPadding(boolean bl2) {
        RecyclerViewOEMV2 recyclerViewOEMV2 = this.mOEMRecyclerView;
        if (recyclerViewOEMV2 != null) {
            recyclerViewOEMV2.setClipToPadding(bl2);
        }
    }
    ...
    public void setLayoutStyle(bld bld2) {
        ...
        RecyclerViewAdapterV2$1 recyclerViewAdapterV2$1 = new RecyclerViewAdapterV2$1(this, bld2);
        bld2 = this.mOEMRecyclerView;
        if (bld2 != null) {
            bld2.setLayoutStyle(recyclerViewAdapterV2$1);
        }
    }

    public void setOemRecyclerView(RecyclerViewOEMV2 object, RecyclerViewAttributesOEMV1 object2) {
    ...
    public void setPadding(int n2, int n3, int n4, int n5) {
        RecyclerViewOEMV2 recyclerViewOEMV2 = this.mOEMRecyclerView;
        if (recyclerViewOEMV2 != null) {
            recyclerViewOEMV2.getView().setPadding(n2, n3, n4, n5);
        }
    }
    ...
    public void setPaddingRelative(int n2, int n3, int n4, int n5) {
        RecyclerViewOEMV2 recyclerViewOEMV2 = this.mOEMRecyclerView;
        if (recyclerViewOEMV2 != null) {
            recyclerViewOEMV2.getView().setPaddingRelative(n2, n3, n4, n5);
        }
    }
