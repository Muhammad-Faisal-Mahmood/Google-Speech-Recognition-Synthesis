...
extends CheckBox {
    ...
    public hg(Context object, AttributeSet attributeSet) {
        lv.a((Context)object);
        super((Context)object, attributeSet, 2130968810);
        lt.d((View)this, this.getContext());
        object = new hi((CompoundButton)this);
        this.a = object;
        ((hi)object).b(attributeSet, 2130968810);
        this.b = object = new hf((View)this);
        ((hf)object).b(attributeSet, 2130968810);
        this.c = object = new ie((TextView)this);
        ((ie)object).h(attributeSet, 2130968810);
        this.a().u(attributeSet, 2130968810);
    }
